...
@click.group()
@click.version_option(version=__version__, prog_name="vectorboard")
def cli() -> None:
    """VectorBoard — LMS course content to AnythingLLM chatbot pipeline."""
...
def run(
    ...
    click.echo("vectorboard run: not yet implemented")
...
def extract(course_zip: str, transcripts: str, output: str) -> None:
    ...
    click.echo("vectorboard extract: not yet implemented")
...
def embed(staging_dir: str, workspace: str, tags: str | None, reset: bool) -> None:
    ...
    click.echo("vectorboard embed: not yet implemented")
...
def chatbot(workspace: str) -> None:
    ...
    click.echo("vectorboard chatbot: not yet implemented")


@cli.command()
def init() -> None:
    """Scaffold a .vectorboard.env configuration file."""
    click.echo("vectorboard init: not yet implemented")
...
def serve(host: str, port: int) -> None:
    """Launch the VectorBoard WebUI."""
    click.echo("vectorboard serve: not yet implemented")
